        ...
        <ul class="cbp-pggrid">
                ...
                <div class="cbp-pgcontent" id="women-1">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG31" id="checkboxG31" class="css-checkbox w3"><label
                                    for="checkboxG31" class="css-label"></label>
                        </li>
                        ...
                        <li class="cbp-pgoptcart">
                            <form action="#" method="post">
                                ...
                                <button type="submit" class="w3l-cart pw3l-cart"><i class="fa fa-cart-plus"
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-2">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG3" id="checkboxG32" class="css-checkbox w3"><label
                                    for="checkboxG32" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-3">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG33" id="checkboxG33" class="css-checkbox w3"><label
                                    for="checkboxG33" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-4">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG34" id="checkboxG34" class="css-checkbox w3"><label
                                    for="checkboxG34" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-5">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG35" id="checkboxG35" class="css-checkbox w3"><label
                                    for="checkboxG35" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
                        ...
                        <li class="cbp-pgoptcart">
                            <button class="btn btn-danger agileits my-cart-btn" data-id="women-5"
                                    data-name="Blue Legging" data-summary="Blue Legging" data-price="17"
                                    data-quantity="1" data-image="images/15-front.jpg"><i class="fa fa-cart-plus"
                                                                                          aria-hidden="true"></i>
                            </button>
                        </li>
                    </ul>
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-6">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG36" id="checkboxG36" class="css-checkbox w3"><label
                                    for="checkboxG36" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-7">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG37" id="checkboxG37" class="css-checkbox w3"><label
                                    for="checkboxG37" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>4.5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="women-8">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG38" id="checkboxG38" class="css-checkbox w3"><label
                                    for="checkboxG38" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
