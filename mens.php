        ...
        <ul class="cbp-pggrid">
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="men-7">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG7" id="checkboxG7" class="css-checkbox w3"><label
                                    for="checkboxG7" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
            ...
            <li class="wthree aits w3l">
                <div class="cbp-pgcontent" id="men-9">
                    ...
                    <ul class="cbp-pgoptions w3l">
                        <li class="cbp-pgoptcompare">
                            <input type="checkbox" name="checkboxG9" id="checkboxG9" class="css-checkbox w3"><label
                                    for="checkboxG9" class="css-label"></label>
                        </li>
                        <li class="cbp-pgoptfav">
                            <span>5 <i class="fa fa-star" aria-hidden="true"></i></span>
                        </li>
