...
<div class="wthreeabout">
    <div class="about-us-grids">
        ...
        <div class="col-md-6 about-us-grid about-us-text">
            <h1>ABOUT US</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras commodo varius vehicula. Mauris porta metus
                vitae nulla dignissim egestas. Aliquam sed molestie eros, in pharetra purus. Praesent consequat porta
                viverra. Praesent gravida dapibus condimentum. Vestibulum vel lacus aliquet, laoreet mi eu, tempor est.
                Quisque volutpat finibus tristique. Duis at nibh eget nulla pretium pretium. Quisque arcu sem, dignissim
                eu egestas quis, vulputate non mauris. Nam varius, odio vel interdum interdum, lectus ante imperdiet
                odio, id consectetur mauris quam et lectus. Ut auctor nec metus egestas auctor. Nullam congue ornare
                dictum. Sed et volutpat lectus. Integer vehicula pharetra ligula, in vehicula magna vehicula eu. Mauris
                at tortor vel eros faucibus feugiat. In hac habitasse platea dictumst. Phasellus molestie pretium mi id
                finibus. Nam et purus enim. Morbi nec fermentum enim. Suspendisse potenti. Sed tincidunt augue in
                pretium lobortis. Donec laoreet nunc a nisi vulputate pulvinar. Morbi aliquam, mi ultricies efficitur
                feugiat, risus magna id consectetur mauris quam et lectus.</p>
        </div>
        <div class="clearfix"></div>
    </div>
</div>
...
<div class="aitsyourself">
    <div class="aitsyourself-grids">
        ...
        <div class="col-md-3 aitsyourself-grid aitsyourself-grid2">
            <h3>“The appearance of things changes according to the emotions; and thus we see magic and beauty in them,
                while the magic and beauty are really in ourselves.”</h3>
            <h4>― Kahlil Gibran</h4>
        </div>
...
<div class="aitscommercial">
    ...
    <div class="col-md-6 aitscommercial-grid aitscommercial-grid1">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras commodo varius vehicula. Mauris porta metus
            vitae nulla dignissim egestas. Aliquam sed molestie eros, in pharetra purus. Praesent consequat porta
            viverra. Praesent gravida dapibus condimentum. Vestibulum vel lacus aliquet, laoreet mi eu, tempor est.
            Quisque volutpat finibus tristique. Duis at nibh eget nulla pretium pretium. Quisque arcu sem, dignissim eu
            egestas quis, vulputate non mauris.</p>
...
<div class="w3laccessoriesaits">
    <div class="col-md-6 w3laccessoriesaits-grids w3laccessoriesaits-grids1">
        <div class="w3laccessoriesaits-grid w3laccessoriesaits-grid1">
            ...
            <h6><a href="mens_accessories.php">Shop Now</a></h6>
        </div>
    </div>
...
<div class="w3lsshoesaits">
    <div class="w3lsshoesaits-info">
        ...
        <div class="wthreeshop-a">
            <a href="womens_accessories.php">SHOP WOMEN'S SHOES</a>
        </div>
    </div>
</div>
<!-- //Shoes -->
