                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <p class="note"><strong>Note:</strong> works in Chrome, Firefox, Opera
                                                    and IE10.</p>
                                            </div>
                        ...
                        <div class="content-box-large">
                            ...
                            <div class="panel-body">
                                ...
                                <div>
                                    <h4>Select</h4>
                                    <p>
                                    <div class="bfh-selectbox" data-name="selectbox3" data-value="12"
                                         data-filter="true">
                                ...
                                <div>
                                    ...
                                    <p>
                                    <div class="bfh-selectbox bfh-currencies" data-currency="EUR"
                                         data-flags="true"></div>
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p>
                                    <div class="bfh-selectbox bfh-languages" data-language="en_US"
                                         data-flags="true"></div>
                                    </p>
                                </div>
                                    ...
                                    <table id="user" class="table table-bordered table-striped" style="clear: both">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" id="group" data-type="select" data-pk="1" data-value="5"
                                                   data-title="Select group" class="editable editable-click">Admin</a>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div id="rootwizard">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <li class="previous disabled"><a href="javascript:void(0);">Previous</a>
                                            </li>
                                            <li class="next last" style="display:none;"><a href="javascript:void(0);">Last</a>
                                            </li>
