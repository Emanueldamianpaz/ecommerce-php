...
<head>
    ...
    <title>Davinci Ecommerce | Home :: W3layouts</title>
        ...
        <div class="container">
            ...
            <div id="bs-megadropdown-tabs" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle w3-agile hyper" data-toggle="dropdown"><span> Hombre </span></a>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle hyper" data-toggle="dropdown"><span> Mujer </span></a>
